...
# Frames 3 and 4 of the five-frame spend: optional CREATE2 + claim, then
# executeBatch (empty calls is a no-op). Pinned like every other budget.
CLAIM_FRAME_GAS = 500_000
CLAIM_FRAME_STATE_GAS = 200_000
EXECUTE_FRAME_GAS = 500_000
EXECUTE_FRAME_STATE_GAS = 100_000
ENSURE_AND_CLAIM_CALLDATA = 132
